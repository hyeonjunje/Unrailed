...
public class Action_GatherResource : BaseFSMAction<Action_GatherResource.EState>
{
    ...
    protected override void OnEnter()
    {
        switch (State)
        {
            ...
            case EState.MoveToResource:
                Navigation.MoveTo(Target.transform.position);
                break;
            ...
            case EState.ReturnHome:
                //Navigation.MoveTo(LinkedAIState.Home.GetRandomSafePoint());
                break;
    ...
    protected override void OnTick()
    {
        switch (State)
        {
            ...
            case EState.ReturnHome:
/*                if (!Navigation.AtDestination && !Navigation.IsFindingOrFollowingPath)
                {
